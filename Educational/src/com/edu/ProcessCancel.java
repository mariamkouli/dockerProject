	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Class.forName("com.mysql.jdbc.Driver").newInstance();
			 ...
			 out.println(HTML_START+"<h1>remaining lessons</h1><form action='ProcessCancel' method='GET' id='searchfield'>"+"<TABLE><TR>\r\n" + 
				 		"<TD>\r\n" );
				 out.println("ID</TD>\r\n"+ 
					 		"<TD>");
				 out.println("Name</TD>\r\n"+  
			 ...
			 for (int i=0;i<checkboxValues.length; i++) {
				st.executeUpdate("DELETE FROM slessons WHERE sid='"+request.getParameter("studentNumber")+"' AND ID='"+checkboxValues[i]+"'");
				  }
